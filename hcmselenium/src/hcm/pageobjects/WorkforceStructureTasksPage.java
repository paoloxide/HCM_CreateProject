...
public class WorkforceStructureTasksPage extends BasePage {
	...
	public void clickTask(String menu){
		...
		jsFindThenClick("//li/a[contains(text(),'"+ menu +"')]");
		log("Clicking " + menu +"...");
	...
	public void clickNext(){
		...
		jsFindThenClick("//a/span[text()='Ne']");
		log("Clicking Next...");
	...
	public void clickYesButton(){
		...
		jsFindThenClick("//button[text()='es']");
		log("Clicking Yes...");
	...
	public void clickSubmitButton(){
		...
		jsFindThenClick("//a/span[text()='Submit']");
		log("Clicking Submit...");
	...
	public void clickSearchButton(){
		...
		jsFindThenClick("//button[text()='Search']");
		log("Clicking Search...");
	...
	public void jsScrollIntoView(String dataPath){
		JavascriptExecutor js = (JavascriptExecutor)driver;
		js.executeScript(
			"function getElementByXPath(xPath){"+
					"	return document.evaluate(xPath, document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;"+
	...
	public String[] findAllAvailableLabels() throws Exception{
		...
		int i = 0;
		java.util.List<WebElement> queryFolder = driver.findElements(By.xpath("//label[contains(@for,'content')]"));
